...
from Model.elegantrl_.train_.config import build_env
from Model.elegantrl_.train_.evaluator import Evaluator
from Model.elegantrl_.train_.replay_buffer import ReplayBuffer, ReplayBufferList
...
def train_and_evaluate(args):
    ...
    if type(agent).__name__ == "AgentRandom":
        print("Random model is not trained")
